...
![Demo1](demos/shared/demo2.gif)

 - [Open demo](demos/multiple_emitters/emitter.js)
 - [Source code](demos/multiple_emitters/emitter.js)

## Multiple Particle Emitters

![Demo1](demos/shared/demo1.gif)

 - [Open demo](demos/single_emitter/emitter.js)
 - [Source code](demos/single_emitter/emitter.js)
...
For details see the [documentation](docs/index.md) and the source code for [single emitters](demos/single_emitter/emitter.js) and [multiple emitters]((demos/multiple_emitters/emitter.js)).
